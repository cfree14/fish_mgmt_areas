...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Faroe Islands", # required
    System_code = "fro", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Faeroe\"", # required
    System_type = "Faroe Islands EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Faroe Islands EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "faroe_islands", "faroe_islands_1.Rds"))
