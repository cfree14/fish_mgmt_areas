...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Iceland", # required
    System_code = "isl", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Iceland\"", # required
    System_type = "Iceland EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Iceland EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "iceland", "iceland_1.Rds"))
