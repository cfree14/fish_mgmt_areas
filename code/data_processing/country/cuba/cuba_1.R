...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Cuba", # required
    System_code = "cub", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Cuba\"", # required
    System_type = "Cuba EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Cuba EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "cuba", "cuba_1.Rds"))
