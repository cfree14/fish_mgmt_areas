...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Senegal", # required
    System_code = "sen", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Senegal\"", # required
    System_type = "Senegal EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Senegal EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "senegal", "senegal_1.Rds"))
