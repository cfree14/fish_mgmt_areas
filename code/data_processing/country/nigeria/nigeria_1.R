...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Nigeria", # required
    System_code = "nga", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Nigeria\"", # required
    System_type = "Nigeria EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Nigeria EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "nigeria", "nigeria_1.Rds"))
