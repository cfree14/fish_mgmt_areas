...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Morocco", # required
    System_code = "mar", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Moro\"", # required
    System_type = "Morocco EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Morocco EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "morocco", "morocco_1.Rds"))
