...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Fiji", # required
    System_code = "fji", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Fiji\"", # required
    System_type = "Fiji EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Fiji EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "fiji", "fiji_1.Rds"))
