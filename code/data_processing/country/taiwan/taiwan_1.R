...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Taiwan", # required
    System_code = "twn", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Taiwan\"", # required
    System_type = "Taiwan EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Taiwan EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "taiwan", "taiwan_1.Rds"))
