...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Suriname", # required
    System_code = "sur", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Suriname\"", # required
    System_type = "Suriname EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Suriname EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "suriname", "suriname_1.Rds"))
