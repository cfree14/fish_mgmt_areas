...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Vietnam", # required
    System_code = "vnm", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Viet\"", # required
    System_type = "Vietnam EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Vietnam EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "vietnam", "vietnam_1.Rds"))
