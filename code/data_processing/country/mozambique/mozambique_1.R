...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Mozambique", # required
    System_code = "moz", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Mozamb\"", # required
    System_type = "Mozambique EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Mozambique EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "mozambique", "mozambique_1.Rds"))
