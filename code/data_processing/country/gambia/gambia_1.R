...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Gambia", # required
    System_code = "gmb", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Gambia\"", # required
    System_type = "Gambia EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Gambia EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "gambia", "gambia_1.Rds"))
