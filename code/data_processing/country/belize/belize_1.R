...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Belize", # required
    System_code = "blz", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Belize\"", # required
    System_type = "Belize EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Belize EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "belize", "belize_1.Rds"))
