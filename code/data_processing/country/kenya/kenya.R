...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Kenya", # required
    System_code = "ken", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Kenya\"", # required
    System_type = "Kenya EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Kenya EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "kenya", "kenya_1.Rds"))
