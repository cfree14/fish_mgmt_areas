...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Sri Lanka", # required
    System_code = "lka", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Lanka\"", # required
    System_type = "Sri Lanka EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Sri Lanka EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "sri_lanka", "sri_lanka_1.Rds"))
