...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Latvia", # required
    System_code = "lva", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Latvia\"", # required
    System_type = "Latvia EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Latvia EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "latvia", "latvia_1.Rds"))
