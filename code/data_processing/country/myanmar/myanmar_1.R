...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Myanmar", # required
    System_code = "mmr", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Myanmar\"", # required
    System_type = "Myanmar EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Myanmar EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "myanmar", "myanmar_1.Rds"))
