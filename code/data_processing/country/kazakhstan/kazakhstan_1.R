...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Kazakhstan", # required
    System_code = "kaz", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Kazak\"", # required
    System_type = "Kazakhstan EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Kazakhstan EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "kazakhstan", "kazakhstan_1.Rds"))
