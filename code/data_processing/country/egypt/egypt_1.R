...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Egypt", # required
    System_code = "egy", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Egypt\"", # required
    System_type = "Egypt EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Egypt EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "egypt", "egypt_1.Rds"))
