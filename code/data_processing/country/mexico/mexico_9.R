...
# Read data
data_orig <- st_read(file.path(basedir, "raw", "country", "mexico", "camaron_rojo_contoy.shp")) %>%
...
data = data %>% # required
  ...
  mutate(
    ...
    Owner_country = "mex",
    System_name_english = "Red Shrimp and Rock Shrimp Fishery Management Plan", # required
    ...
    System_source = "Instituto Nacional de Pesca y Acuacultura. (25 March 2014). Plan de Manejo Pesquero de camarón rojo y camarón de roca. www.gob.mx/inapesca. Retrieved 14 March 2023:", # required
    System_source_date = "2014-03-25", # required
    System_shape_file = "camaron_rojo_contoy.shp",
    System_license_terms = "Public Domain", # required
    System_lineage = "Digitized by Alicia Caughman in QGIS on April 14 2023", # required
    System_type = "Red Shrimp and Rock Shrimp Management Area", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Red Shrimp and Rock Shrimp Fishery", # required
    Area_descriptive_name = "camarón rojo y camarón de roca",
...
saveRDS(data, file = file.path(basedir, "processed", "country", "mexico", "mexico_9.Rds"))
