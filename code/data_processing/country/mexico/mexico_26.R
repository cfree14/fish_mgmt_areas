...
# Read data
data_orig <- st_read(file.path(basedir, "raw", "country", "mexico", "rocotes.shp")) %>%
...
data = data %>% # required
  ...
  mutate(
    ...
    Owner_country = "mex",
    System_name_english = "National Fishing Card for Scorpaenidae", # required
    System_name_localized = "Carta Nacional Pesquera",
    System_code = "SFW NFC", # required
    System_code_localized = "SFW CNP",
    System_code_official = "0", # required
    System_multispecies = "1",
    System_species_description = paste("Scorpaenidae"),
    ...
    Area_systematic_name_english = "Capture Area for Scorpaendae", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "mexico", "mexico_26.Rds"))
