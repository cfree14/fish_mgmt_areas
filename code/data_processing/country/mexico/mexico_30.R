...
# Read data
data_orig <- st_read(file.path(basedir, "raw", "country", "mexico", "cangrejoes.shp")) %>%
...
data = data %>% # required
  ...
  mutate(
    ...
    Owner_country = "mex",
    System_name_english = "National Fishing Card for Land Crab", # required
    System_name_localized = "Carta Nacional Pesquera",
    System_code = "KDG NFC", # required
    System_code_localized = "KDG CNP",
    System_code_official = "0", # required
    System_multispecies = "1",
    System_species_description = paste("Cardisoma guanhumi, Ucides cordatus"),
    ...
    System_shape_file = "cangrejoes.shp",
    ...
    Area_systematic_name_english = "Capture Area for Land Crab", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "mexico", "mexico_30.Rds"))
