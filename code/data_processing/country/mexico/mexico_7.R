...
# Read data
data_orig <- st_read(file.path(basedir, "raw", "country", "mexico", "camaron_7_barbas_camp_tab.shp")) %>%
...
data = data %>% # required
  ...
  mutate(
    ...
    Owner_country = "mex",
    System_name_english = "Seven Barbed Shrimp Fishery Management Plan", # required
    System_name_localized = "Plan de Manejo Pesquero de camarón siete barbas",
    ...
    System_source_date = "2014-03-31", # required
    System_shape_file = "camaron_7_barbas_camp_tab.shp",
    System_license_terms = "Public Domain", # required
    System_lineage = "Digitized by Alicia Caughman in QGIS on April 14 2023", # required
    System_type = "Xiphopenaeus kroyeri Management Area", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Seven Barbed Shrimp Fishery", # required
    Area_descriptive_name = "camarón siete barbas",
