...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Iran", # required
    System_code = "irn", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Iran\"", # required
    System_type = "Iran EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Iran EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "iran", "iran_1.Rds"))
