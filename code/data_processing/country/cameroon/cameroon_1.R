...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Cameroon", # required
    System_code = "cmr", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Cameroon\"", # required
    System_type = "Cameroon EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Cameroon EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "cameroon", "cameroon_1.Rds"))
