...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Turkmenistan", # required
    System_code = "tkm", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Turkmen\"", # required
    System_type = "Turkmenistan EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Turkmenistan EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "turkmenistan", "turkmenistan_1.Rds"))
