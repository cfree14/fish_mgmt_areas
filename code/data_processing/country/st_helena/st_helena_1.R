...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "Saint Helena", # required
    System_code = "shn", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Helena\"", # required
    System_type = "Saint Helena EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "Saint Helena EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "st_helena", "st_helena_1.Rds"))
