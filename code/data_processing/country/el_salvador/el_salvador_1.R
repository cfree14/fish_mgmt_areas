...
data <- data_orig %>%
  ...
  mutate(
    ...
    System_name_english = "El Salvador", # required
    System_code = "slv", # required
    ...
    System_lineage = "Filtered eez_v11.shp to so that GEONAME contained \"Salvador\"", # required
    System_type = "El Salvador EEZ", # required
    System_category = "Management Area", # required
    Area_systematic_name_english = "El Salvador EEZ", # required
...
saveRDS(data, file = file.path(basedir, "processed", "country", "el_salvador", "el_salvador_1.Rds"))
