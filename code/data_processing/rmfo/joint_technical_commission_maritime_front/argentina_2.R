...
# Read data
data_orig <- readRDS(file.path(basedir, "raw", "country", "argentina", "Argentina_Uruguay_CMTFM.RDS"))
...
data <- data_orig %>%
  ...
  mutate(Owner_name_english = "Joint Technical Comission of the Maritime Front",
         System_source = "Joint Technical Comission on the Marine Front (CMTFM). (23 June 2022). https://ctmfm.org/. https://www.magyp.gob.ar/sitio/. Retrieved 28 July 2022: https://ctmfm.org/resoluciones/area-de-veda/?a=&e=9&n=")
...
saveRDS(data, file = file.path(basedir, "processed", "rmfo", "joint_technical_commission_maritime_front", "argentina_1.Rds"))
