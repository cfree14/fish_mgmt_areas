...
# Read data
data_orig <- st_read(file.path(basedir, "raw", "rmfo", "commission_conservation_antartic_marine_living_resources", "research_blocksPolygon.shp"))
...
data <- data %>%
  ...
  mutate(
    ...
    System_name_english = "CCAMLR Research Blocks", # required
    ...
    System_type = "Research Block", # required
...
saveRDS(data, file = file.path(basedir, "processed", "rmfo", "commission_conservation_antartic_marine_living_resources", "commission_conservation_antartic_marine_living_resources_2.Rds"))
